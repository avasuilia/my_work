...
def parse_args():
    ...
    parser.add_argument('--cyc_weight', type=float, default=0, help='Weight for cyclic consistency loss')
    parser.add_argument('--r1_weight', type=float, default=0, help='Weight for R1 regularization')

    parser.add_argument('--gan_type', type=str, default='gan', help='gan / lsgan / gan-gp / hinge')
